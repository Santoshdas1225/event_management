            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-20">All Bookings</h4>
                                ...
                                <tbody>
                                    ...
                                    <td>{{$d->payment_id}}</td>
                                        ...
                                        @if($d->is_paid == 1)
                                         ...
                                         @endif
                                         <td> <a class="btn btn-outline-secondary btn-sm edit delete-btn" href="{{url('/')}}/admindeletebooking/{{$d->id}}" title="Delete">
